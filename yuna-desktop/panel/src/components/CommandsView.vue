<template>
  <section class="cmds">
    <div v-if="!engine.available" class="card warn">
      Движок команд ещё подключается (эндпоинт <code>/api/command</code> появится с T5).
      Команды можно готовить здесь — они сохранятся локально и уйдут на мост, когда он будет готов.
    </div>
